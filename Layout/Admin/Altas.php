...
<html lang="en">
    ...
    <body>
        <?php
            if (!$_GET) {
                header('Location:Altas.php?pagina=1');
            }
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto p-2">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page"  href="<?php echo $URL;?>/Layout/Admin/Index.php">
                                <i class="fas fa-home mr-2 lead fa-fw me-3"></i>Inicio
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="<?php echo $URL;?>/Layout/Admin/Altas.php">
                    ...
                    <main class="row overflow-hidden overflow-x-auto overflow-y-scroll ">
                        <div class="col">
                            ...
                            <h1 class="display-3 text-center"> Atlas </h1>
                                ...
                                <input type="text" id="searchInput" placeholder="Buscar..." class="col-12 pt-2 pb-2">
                                                    ...
                                                    <div class="modal fade" id="Editar<?= $dato["Id"]?>" tabindex="-1" aria-labelledby="ModalEditar" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <?php include('../../App/Php/ModalEditar.php');?>
                                                                </div>                    
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <!-- Jquery -->
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        ...
                        var paginaActual = <?php echo $paginaActual; ?>; // Obtén la página actual desde PHP
