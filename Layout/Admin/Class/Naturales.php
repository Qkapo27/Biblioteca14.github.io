<?php 
    ...
    $sql_total_libros = 'SELECT COUNT(*) as total FROM Inventario WHERE Materia = "Naturales"';
...
<html lang="en">
    ...
    <body>
        <?php
            if (!$_GET) {
                header('Location:Naturales.php?pagina=1');
            }
            ...
            $sql_articulos = 'SELECT * FROM Inventario WHERE Materia = "Naturales" LIMIT :iniciar, :narticulos';
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto p-2">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo $URL;?>/Layout/Admin/Index.php">
    ...
    <!-- Portadas -->
        <h1 class="text-center">Libros de Ciencias <img src="../../../Public/Img/Icons/Nat.png" alt="" class="mr-2 fa-fw me-3"><strong> Naturales</strong></h1>
        <hr>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo $_GET['pagina']<=1? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Naturales.php?pagina=<?php echo $_GET['pagina']-1 ?>" aria-label="Previous">
                            ...
                            <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : ' ' ?>" >
                                <a class="page-link" href="Naturales.php?pagina=<?php echo $i+1?>">
                                    <?php echo $i+1?>
                                </a>
                            </li>
                            ...
                            <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Naturales.php?pagina=<?php echo $_GET['pagina']+1 ?>" aria-label="Next">
