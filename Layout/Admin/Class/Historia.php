<?php 
    ...
    $sql_total_libros = 'SELECT COUNT(*) as total FROM Inventario WHERE Materia = "Historia"';
...
<html lang="en">
    ...
    <body>
        <?php
            if (!$_GET) {
                header('Location:Historia.php?pagina=1');
            }
            ...
            $sql_articulos = 'SELECT * FROM Inventario WHERE Materia = "Historia" LIMIT :iniciar, :narticulos';
    ...
    <!-- Portadas -->
        <h1 class="text-center">Libros de <img src="../../../Public/Img/Icons/Historia.png" alt="" class="mr-2 fa-fw me-3"><strong>Historia</strong></h1>
        <hr>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo $_GET['pagina']<=1? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Historia.php?pagina=<?php echo $_GET['pagina']-1 ?>" aria-label="Previous">
                            ...
                            <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : ' ' ?>" >
                                <a class="page-link" href="Historia.php?pagina=<?php echo $i+1?>">
                                    <?php echo $i+1?>
                                </a>
                            </li>
                            ...
                            <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Historia.php?pagina=<?php echo $_GET['pagina']+1 ?>" aria-label="Next">
