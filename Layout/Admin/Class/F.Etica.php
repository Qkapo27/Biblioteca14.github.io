<?php 
    ...
    $sql_total_libros = 'SELECT COUNT(*) as total FROM Inventario WHERE Materia = "F.Etica"';
...
<html lang="en">
    ...
    <body>
        <?php
            if (!$_GET) {
                header('Location:F.Etica.php?pagina=1');
            }
            ...
            $sql_articulos = 'SELECT * FROM Inventario WHERE Materia = "F.Etica" LIMIT :iniciar, :narticulos';
    ...
    <!-- Portadas -->
        <h1 class="text-center">Libros de <img src="../../../Public/Img/Icons/F.Etica.png" alt="" class="mr-2 fa-fw me-3"><strong>Formacion Etica</strong></h1>
        <hr>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo $_GET['pagina']<=1? 'disabled' : ' ' ?>">
                                <a class="page-link" href="F.Etica.php?pagina=<?php echo $_GET['pagina']-1 ?>" aria-label="Previous">
                            ...
                            <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : ' ' ?>" >
                                <a class="page-link" href="F.Etica.php?pagina=<?php echo $i+1?>">
                                    <?php echo $i+1?>
                                </a>
                            </li>
                            ...
                            <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled' : ' ' ?>">
                                <a class="page-link" href="F.Etica.php?pagina=<?php echo $_GET['pagina']+1 ?>" aria-label="Next">
