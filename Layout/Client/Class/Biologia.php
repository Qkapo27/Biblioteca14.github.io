<?php 
    ...
    $sql_total_libros = 'SELECT COUNT(*) as total FROM Inventario WHERE Materia = "Biologia"';
...
<html lang="en">
    ...
    <body>
        <?php
            if (!$_GET) {
                header('Location:Biologia.php?pagina=1');
            }
            ...
            $sql_articulos = 'SELECT * FROM Inventario WHERE Materia = "Biologia" LIMIT :iniciar, :narticulos';
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                                <li class="nav-item">
                                    ...
                                    <a class="dropdown-item" href="Diccionarios.php">                            
                                    <img src="../../../Public/Img/Icons/Diccionario.png" alt="" class="mr-2 lead fa-fw me-3">Diccionarios
                                    </a>
                                </li>
                            </ul>
                    </li>
    ...
    <!-- Portadas -->
        <h1 class="text-center"><img src="../../../Public/Img/Icons/Biologia.png" alt="" class="mr-2 fa-fw me-3"><strong>Biologia</strong></h1>
        <hr>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <li class="page-item <?php echo $_GET['pagina']<=1? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Biologia.php?pagina=<?php echo $_GET['pagina']-1 ?>" aria-label="Previous">
                            ...
                            <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : ' ' ?>" >
                                <a class="page-link" href="Biologia.php?pagina=<?php echo $i+1?>">
                                    <?php echo $i+1?>
                                </a>
                            </li>
                            ...
                            <li class="page-item <?php echo $_GET['pagina']>=$paginas? 'disabled' : ' ' ?>">
                                <a class="page-link" href="Biologia.php?pagina=<?php echo $_GET['pagina']+1 ?>" aria-label="Next">
